...
TEST(GmpFunctions, ceil) {
    ...
    EXPECT_TRUE(ceil(x) == -1);

    x = mpf_class("1."
                  "213341545346456345647667356736573657356736573573567356735673"
                  "5735735735");

    EXPECT_TRUE(ceil(x) == 2);
}
...
TEST(GmpFunctions, round) {
    ...
    EXPECT_TRUE(round(x) == mpz_class("1349218409"));
