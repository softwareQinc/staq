...
inline RzApproximation find_fast_rz_approximation(const real_t& theta,
    ...
    while ((not solution_found) && (k < max_k)) {
        ...
        // solution
        //if((A_x.width()*B_x.width()<min_width) or (A_y.width()*B_y.width()<min_width)) {
        //    k++;
